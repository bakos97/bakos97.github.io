...
As we all know, the COVID-19 pandemic has caused significant changes in our lives, and the city of San Francisco is no exception. One of the many ways it has impacted the city is in its crime patterns. To understand the relationship between crime rates and the pandemic timeline in San Francisco, we will use an interactive Bokeh visualization.

Through this visualization, we will explore the changes in crime rates in San Francisco before and during the pandemic. By looking at crime data from the San Francisco Police Department and COVID-19 case data, we will be able to see how crime patterns have shifted over time.

This visualization will allow us to dive deeper into the data and see which crime categories have been most affected by the pandemic. We will also be able to highlight specific crime categories to see how they have changed over time.

<iframe src="https://bakos97.github.io/crime_vs_covid5.html" width="100%" height="500"></iframe>
The plot highlights the impact of the pandemic on crime rates in the city, with a clear increase in COVID-19 cases accompanying a decrease in reported crimes. The top line represents the daily count of new COVID-19 cases, while the dots represent the number of reported crimes in various categories such as Larceny Theft, Assault, Vandalism, Burglary, and Motor Vehicle Theft. The plot also emphasizes the focus categories of crime in the city, allowing us to analyze the relationship between crime and the pandemic's timeline more effectively. Overall, this visualization provides valuable insights into the changing dynamics of crime patterns in San Francisco during the pandemic. We can see that the crimes dips down as soon as the first corona cases hit. But from the first corona cases the crimes does not really decrease over time. The crime does dip a bit when the corona cases hits it peak.
...
Our interactive Bokeh visualization clearly shows the correlation between the pandemic timeline and crime rates in San Francisco, demonstrating the pandemic's direct impact on public safety. This information can be used by policymakers to allocate additional resources where needed and raise awareness of the challenges faced by local businesses during this time.

As we continue to navigate the pandemic's effects, it is crucial to remain vigilant about public safety in our cities. By working together, we can ensure that San Francisco remains a safe and thriving place to live and work for years to come.